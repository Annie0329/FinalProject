...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TurnBasedRPG",33,d2,d9,a2),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TurnBasedRPG",33,d2,d9,a2));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TurnBasedRPG",33,d2,d9,a2));
