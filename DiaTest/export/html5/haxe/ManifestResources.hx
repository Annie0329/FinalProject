...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_testmap_json extends null { }
...
@:keep @:file("assets/data/testMap.json") @:noCompletion #if display private #end class __ASSET__assets_data_testmap_json extends haxe.io.Bytes {}
