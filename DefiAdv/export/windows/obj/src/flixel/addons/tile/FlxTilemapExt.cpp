...
HXLINE( 153)		 ::openfl::display::BitmapData debugTile;
...
HXDLIN( 188)							if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 188)								_hx_tmp = !(this->ignoreDrawDebug);
            							}
            							else {
HXLINE( 188)								_hx_tmp = false;
            							}
HXDLIN( 188)							if (_hx_tmp) {
HXLINE( 190)								if (::hx::IsNotNull( tile )) {
HXLINE( 192)									if ((tile->allowCollisions <= 0)) {
HXLINE( 194)										debugTile = this->_debugTileNotSolid;
            									}
            									else {
HXLINE( 196)										if ((tile->allowCollisions != 4369)) {
HXLINE( 198)											debugTile = this->_debugTilePartial;
            										}
            										else {
HXLINE( 202)											debugTile = this->_debugTileSolid;
            										}
            									}
HXLINE( 205)									{
HXLINE( 205)										 ::flixel::math::FlxPoint _this = this->offset;
HXDLIN( 205)										 ::openfl::geom::Point FlashPoint = this->_flashPoint;
HXDLIN( 205)										 ::openfl::geom::Point FlashPoint1 = FlashPoint;
HXDLIN( 205)										FlashPoint1->x = (FlashPoint1->x + _this->x);
HXDLIN( 205)										 ::openfl::geom::Point FlashPoint2 = FlashPoint;
HXDLIN( 205)										FlashPoint2->y = (FlashPoint2->y + _this->y);
            									}
HXLINE( 206)									Buffer->pixels->copyPixels(debugTile,this->_debugRect,this->_flashPoint,null(),null(),true);
HXLINE( 207)									{
HXLINE( 207)										 ::flixel::math::FlxPoint _this1 = this->offset;
HXDLIN( 207)										 ::openfl::geom::Point FlashPoint3 = this->_flashPoint;
HXDLIN( 207)										 ::openfl::geom::Point FlashPoint4 = FlashPoint3;
HXDLIN( 207)										FlashPoint4->x = (FlashPoint4->x - _this1->x);
HXDLIN( 207)										 ::openfl::geom::Point FlashPoint5 = FlashPoint3;
HXDLIN( 207)										FlashPoint5->y = (FlashPoint5->y - _this1->y);
            									}
            								}
            							}
            						}
