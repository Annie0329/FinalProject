...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_fptest_ogmo extends null { }
...
@:keep @:file("assets/data/dialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_dialogue_txt extends haxe.io.Bytes {}
@:keep @:file("assets/data/FPTest.ogmo") @:noCompletion #if display private #end class __ASSET__assets_data_fptest_ogmo extends haxe.io.Bytes {}
