...
HX_DEFINE_STACK_FRAME(_hx_pos_5de81b3c4b5a507c_30_new,"FSM","new",0x0313b752,"FSM.new","Enemy.hx",30,0xbda88996)
HX_LOCAL_STACK_FRAME(_hx_pos_5de81b3c4b5a507c_35_update,"FSM","update",0x2caf0257,"FSM.update","Enemy.hx",35,0xbda88996)

void FSM_obj::__construct( ::Dynamic initialState){
            	HX_STACKFRAME(&_hx_pos_5de81b3c4b5a507c_30_new)
HXDLIN(  30)		this->activeState = initialState;
            	}
...
void FSM_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_5de81b3c4b5a507c_35_update)
HXDLIN(  35)		this->activeState(elapsed);
            	}
