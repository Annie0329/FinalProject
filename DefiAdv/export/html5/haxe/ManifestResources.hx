...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_bagopen_mp3 extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_gateopen_mp3 extends null { }
...
@:keep @:file("assets/sounds/bagOpen.mp3") @:noCompletion #if display private #end class __ASSET__assets_sounds_bagopen_mp3 extends haxe.io.Bytes {}
...
@:keep @:file("assets/sounds/gateOpen.mp3") @:noCompletion #if display private #end class __ASSET__assets_sounds_gateopen_mp3 extends haxe.io.Bytes {}
