...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_gametheme_loud__mp3 extends null { }
...
@:keep @:file("assets/music/gameTheme(LOUD).mp3") @:noCompletion #if display private #end class __ASSET__assets_music_gametheme_loud__mp3 extends haxe.io.Bytes {}
